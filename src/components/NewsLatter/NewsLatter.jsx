                  ...
                  <div className=" container mx-auto h-96 bg-indigo-700 w-full  flex items-center justify-center text-center rounded-xl" id="newslater-contenar">
                        <div className=" space-y-3 ">
                              ...
                              <form onSubmit={handleNewsLatterSignIn} className="  flex items-center justify-center ">
                                    <input required placeholder='Enter your email' type="email" name="email" id="" className="input rounded-l px-4 py-3 w-11/12 join-item focus:outline-none focus:border-none" />
