  ...
  return (
    <div>
      <div className=" text-start shadow-md  bg-white rounded relative  border-2 h-full">
        <div className="text-sm absolute right-2 top-1 "></div>
        <img className="  lg:h-40 xl:h-48 w-full" src={news?.image} alt="" />
        <div className="p-3 flex flex-col lg:gap-1  justify-between h-44  ">
